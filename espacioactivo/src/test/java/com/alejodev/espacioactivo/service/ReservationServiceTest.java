...
//        // cargamos el turno asociado en la reserva
//        appointmentDTO.setId(1L);
//        appointmentDTO.setUserDTO(activityProviderUserDTO);
//        appointmentDTO.setDisciplineDTO(disciplineDTOForActivity);
//
//        // cargamos la reserva
//        userDTO.setId(4L);
//        reservationDTOForCreate.setUserDTO(userDTO);
